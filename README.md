...
- Obfuscator runner: `wc3-confuse` is excluded from the workspace (mlua `lua51` vs `lua54` features are mutually exclusive); build it standalone with `cargo build --manifest-path crates/wc3-confuse/Cargo.toml`
